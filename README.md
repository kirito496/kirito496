# NOVA 360 — Agence Créative Full-Service

Site vitrine de l'agence, avec un décor 3D animé (lentille de verre qui voyage au défilement)
et un formulaire de contact dont les messages sont enregistrés dans une base PostgreSQL.

## Structure

- `public/index.html` — le site complet (HTML/CSS/JS, aucun framework)
- `server.js` — serveur Express : sert le site + API du formulaire de contact
- API :
...
6. Obtenir l'adresse publique : service web → **Settings → Networking → Generate Domain**
